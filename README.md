...
1. Descarga `Calificador Interactivo Setup 2.6.0.exe`.
...
1. Descarga `Calificador Interactivo-2.6.0.dmg`.
...
| [Electron.js](https://www.electronjs.org/) v42 | Framework de escritorio multiplataforma |
